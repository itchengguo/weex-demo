...
import com.ringha.app.hotreload.HotReloadManager;
import com.ringha.app.util.AppConfig;
import com.ringha.app.util.Constants;
...
public class WXPageActivity extends AbsWeexActivity implements
    ...
    public void onCreateNestInstance(WXSDKInstance instance, NestedContainer container) {
        WXLogUtils.e(TAG, "================Nested Instance created.");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (uri != null) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(ws)) {
                    ...
                    WXLogUtils.e("Weex", "==================can not get hot reload config");
                }
        ...
        if (mUri == null) {
            WXLogUtils.e("=========2====mUri==null 读取launchUrl==================");
